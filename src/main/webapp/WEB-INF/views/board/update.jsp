	...
	<div class="row">
		<div class="col-md-12">
			<div class="well well-sm">
				<form action="${pageContext.request.contextPath}/board/update" class="form-horizontal" method="post">
					<fieldset>
						<legend id="legend" class="text-center header"> 게시글수정</legend>
						...
						<div class="form-group">
							...
							<div class="col-md-12">
								<input id="lname" name="name" type="text" placeholder="글쓴이"
									class="form-control" value="${article.id}">
							</div>
						</div>
						...
						<div class="form-group">
							<span class="col-md-1 col-md-offset-2 text-center"> <i
								class="fa fa-user bigicon"></i></span>
							<div class="col-md-12">
								<input id="seq" name="seq" type="hidden" placeholder="글쓴이"
									class="form-control" value="${article.seq}">
							</div>
						</div>						
						...
						<div class="form-group">
							...
							<div class="col-md-12">
								<textarea class="form-control" id="message" name="message"
									rows="10">${article.title}</textarea>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12 text-center">
								<button id="update-btn" type="submit" style="width: 200px"
									class="btn btn-primary btn-lg">수 정</button>
								<button id="cancel-btn" type="reset" style="width: 200px"
